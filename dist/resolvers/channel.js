...
exports.default = {
  Mutation: {
    getOrCreateChannel: _permissions2.default.createResolver(async (parent, { teamId, members }, { models, user }) => {
    ...
    createChannel: _permissions2.default.createResolver(async (parent, args, { models, user }) => {
      try {
